...
export const AdminLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-black to-gray-900 flex items-center justify-center p-4" style={fontStyle}>
      <div className="bg-gray-900 rounded-2xl p-8 shadow-2xl border border-gray-700 max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Sign in with admin credentials to access the dashboard</p>
        </div>
