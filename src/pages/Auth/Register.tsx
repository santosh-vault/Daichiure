      ...
      <div className="relative h-full w-full max-w-md bg-gray-900 rounded-l-3xl shadow-2xl border-l border-gray-800 flex flex-col animate-slide-in-right">
        ...
        <div className="flex-1 flex flex-col justify-center px-6 py-10 sm:px-8">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold font-['Bruno_Ace_SC'] text-amber-400 mb-2 drop-shadow-md">
              Join PlayHub
            </h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full pl-10 pr-4 py-3 bg-gray-800 border text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 ${
                    emailError
