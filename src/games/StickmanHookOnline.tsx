...
const StickmanHookOnline: React.FC = () => {
  const [gameStartTime] = useState(Date.now());
  const [gameEnded, setGameEnded] = useState(false);

  useGameCoins({
    gameId: "StickmanHookOnline",
    trigger: gameEnded,
  ...
  return (
    <div className="game-container w-full flex justify-center">
      <iframe
        ...
        src="https://play.gamepix.com/stickman-hook-online/embed?sid=322U0"
        width="900"
        height="600"
        frameBorder="0"
        scrolling="no"
...
export default StickmanHookOnline;
