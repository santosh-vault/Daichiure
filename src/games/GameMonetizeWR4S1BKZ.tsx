...
const GameMonetizeWR4S1BKZ: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <iframe
        src="https://html5.gamemonetize.co/wr4s1bkz7u57su3t7he5rs9otce1o6ft/"
        width="480"
        height="800"
        scrolling="none"
        frameBorder="0"
        title="Mobile Tower Game"
        style={{
          maxWidth: "100%",
          borderRadius: 12,
...
export default GameMonetizeWR4S1BKZ;
