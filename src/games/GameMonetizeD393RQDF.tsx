...
const GameMonetizeD393RQDF: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <iframe
        src="https://html5.gamemonetize.co/d393rqdfe4h6h9zk25nzv2459pnqeelq/"
        width="800"
        height="600"
        scrolling="none"
        frameBorder="0"
        title="Strategy Quest Game"
        style={{
          maxWidth: "100%",
          borderRadius: 12,
...
export default GameMonetizeD393RQDF;
